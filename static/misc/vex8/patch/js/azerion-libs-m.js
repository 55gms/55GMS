...
!(function (global, factory) {
    ...
    : factory(
        ((global =
          "undefined" != typeof globalThis
            ? globalThis
            : global || self).h5branding = global.h5branding || {})
      );
  ...
  createCommonjsModule(function (module, exports) {
    ...
    function attemptVertx() {
      try {
        ...
        return (
          (vertxNext = vertx.runOnLoop || vertx.runOnContext), useVertxTimer()
        );
      } catch (e) {
    ...
    function resolve$1(object) {
      ...
      var promise;
      return object && "object" == typeof object && object.constructor === this
        ? object
        : (resolve((promise = new this(noop)), object), promise);
    }
    function noop() {}
    ...
    function handleMaybeThenable(promise, maybeThenable, then$$1) {
      ...
      maybeThenable.constructor.resolve === resolve$1
        ...
        : void 0 !== then$$1 && isFunction(then$$1)
    ...
    module.exports =
      ...
      (BrowserMutationObserver =
        (browserGlobal = module || {}).MutationObserver ||
        ...
        return (
          ...
          (Enumerator.prototype._eachEntry = function _eachEntry(entry, i) {
            ...
            if (resolve$$1 === resolve$1) {
              ...
              var promise;
              _then === then && entry._state !== PENDING
                ? this._settledAt(entry._state, i, entry._result)
                : "function" != typeof _then
    ...
    return (
      (Sld.has = function (domain) {
        ...
        return (
          !(
            tldOffset <= 0 ||
            tldOffset >= domain.length - 1 ||
            (sldOffset = domain.lastIndexOf(".", tldOffset - 1)) <= 0 ||
            tldOffset - 1 <= sldOffset ||
            !(sldList = list[domain.slice(tldOffset + 1)])
          ) &&
          0 <=
            sldList.indexOf(" " + domain.slice(sldOffset + 1, tldOffset) + " ")
        );
      }),
      (Sld.is = function (domain) {
        ...
        return (
          !(
            tldOffset <= 0 ||
            tldOffset >= domain.length - 1 ||
            0 <= domain.lastIndexOf(".", tldOffset - 1) ||
            !(sldList = list[domain.slice(tldOffset + 1)])
          ) && 0 <= sldList.indexOf(" " + domain.slice(0, tldOffset) + " ")
        );
      }),
  ...
  var Domain = (function () {
    ...
    return (
      ...
      (Domain.getDomain = function (host) {
        var t, t, t;
        return list
          ? (t = host.match(/\./g)) && t.length < 2
            ? host
            : (t = this.getTld(host))
            ? ((t = host.length - t.length - 1),
  ...
  (exports.BrandingDomain = void 0),
    ((BrandingDomain = exports.BrandingDomain || (exports.BrandingDomain = {}))[
      (BrandingDomain.Neutral = 0)
    ] = "Neutral"),
    ...
    return (
      ...
      (Hosts.getYandexBaseURL = function () {
        ...
        if (
          null !=
            (_a =
              null == (_a = window.YandexGamesSDKEnvironment)
                ? void 0
                : _a.browser) &&
          _a.lang &&
  ...
  (exports.UtmTargets = void 0),
    ((BrandingDomain = exports.UtmTargets || (exports.UtmTargets = {}))[
      (BrandingDomain.splashscreen = 0)
    ] = "splashscreen"),
  ...
  var CrossPromo = (function () {
    ...
    return (
      ...
      (CrossPromo.getPromoURL = function (
        domain,
        url,
        host,
        gameTitle,
        ...
        return window.hasOwnProperty("_YaSDK") ||
          ...
          ? "https://".concat(
              Hosts.getYandexBaseURL(),
              "/games/developer?name=Azerion"
            )
          : domain === exports.BrandingDomain.Admeen
          ? "https://media.admeen.com/branding/link.php"
          : domain === exports.BrandingDomain.Bild
          ? url
          : url +
            "/?utm_source=" +
            host +
    ...
    return (
      (PortalScripts.loadPortalScript = function (siteLockList) {
        siteLockList &&
          ...
          -1 !== siteLockList.minijuegos.indexOf(Utils.getSourceSite()) &&
          ...
          siteLockList &&
            ...
            -1 !== siteLockList.kongregate.indexOf(Utils.getSourceSite()) &&
            addScript(
          ...
          siteLockList &&
            ...
            -1 !== siteLockList.newgrounds.indexOf(Utils.getSourceSite()) &&
            addScript(
  ...
  var BuildSettings = (function () {
    ...
    return (
      (BuildSettings.isStandAlone = function () {
        var _a, _a;
        return null != (_a = window._azerionIntegration) && _a.sa
          ? null == (_a = window._azerionIntegration)
            ? void 0
            : _a.sa
      ...
      (BuildSettings.hasDomainForCustomBuild = function () {
        var _a;
        return (
          (null == (_a = window._azerionIntegration) ? void 0 : _a.bd) ||
          window.hasOwnProperty("fbrqBD")
        );
      }),
      (BuildSettings.getDomainForCustomBuild = function () {
        var _a, _a, _a;
        return null != (_a = window._azerionIntegration) &&
          _a.bd &&
          (null == (_a = window._azerionIntegration) ? void 0 : _a.bd) in
            exports.BrandingDomain
          ? null == (_a = window._azerionIntegration)
            ? void 0
            : _a.bd
          : window.hasOwnProperty("fbrqBD") &&
            window.fbrqBD in exports.BrandingDomain
          ? window.fbrqBD
          : void 0;
      }),
      (BuildSettings.hasLinksSettingsForCustomBuild = function () {
        var _a;
        return (
          (null == (_a = window._azerionIntegration) ? void 0 : _a.la) ||
          window.hasOwnProperty("fbrqLA")
        );
      }),
      (BuildSettings.getLinkSettingsForCustomBuild = function () {
        var _a, _a;
        return null != (_a = window._azerionIntegration) && _a.la
          ? null == (_a = window._azerionIntegration)
            ? void 0
            : _a.la
          : window.hasOwnProperty("fbrqLA")
  ...
  var Branding = (function () {
    ...
    return (
      (Branding.preload = function (version) {
        ...
        var promise = Promise.all([
          Loader.instance.load(
            Domain.KEY,
            ""
              .concat(Utils.ASSET_LOCATION, "json/domains.json?v=")
              .concat(version),
            "text/plain"
          ),
          Loader.instance.load(
            Branding.SITELOCK_PORTALS,
            ""
              .concat(Utils.ASSET_LOCATION, "json/sitelock.json?v=")
              .concat(version),
            "text/plain"
          ),
        ]);
        return (
          Promise.all([
            Loader.instance.load(
              Branding.INTERNAL_PORTALS_KEY,
              ""
                .concat(Utils.ASSET_LOCATION, "json/internal.json?v=")
                .concat(version),
              "text/plain"
            ),
            Loader.instance.load(
              Branding.CONTRACTED_PORTALS_KEY,
              ""
                .concat(Utils.ASSET_LOCATION, "json/contracted.json?v=")
                .concat(version),
              "text/plain"
            ),
            Loader.instance.load(
              Branding.SPECIAL_PORTALS_KEY,
              ""
                .concat(Utils.ASSET_LOCATION, "json/special.json?v=")
                .concat(version),
              "text/plain"
            ),
          ]),
      ...
      Object.defineProperty(Branding, "brandingLogoUrl", {
        get: function () {
          return "patch/images/55gms.png";
          var imageName;
          switch (
            (Utils.isOnDevice() || Hosts.isAirfi()
              ? (Utils.ASSET_LOCATION = "assets/")
              : "fbrq.io" === Utils.getSourceSite(!0) &&
                (Utils.ASSET_LOCATION =
                  "https://" +
      ...
      (Branding.openCampaignLink = function (gameTitle, type) {
        ...
        Branding.blockedDomain() ||
          ((type = window.open(gameTitle)) && type.focus && type.focus());
      }),
      (Branding.isInternal = function () {
        return Branding.hostMatchesList(
          Loader.instance.get(Branding.INTERNAL_PORTALS_KEY)
        );
      }),
      (Branding.isContracted = function () {
        return Branding.hostMatchesList(
          Loader.instance.get(Branding.CONTRACTED_PORTALS_KEY)
        );
      }),
      (Branding.isSpecial = function () {
        return Branding.hostMatchesList(
          Loader.instance.get(Branding.SPECIAL_PORTALS_KEY)
        );
      }),
      (Branding.isAdmeen = function () {
        ...
        return (
          !(
            !Branding.siteLocks || !Branding.siteLocks.hasOwnProperty("admeen")
          ) &&
          ((admeen = Branding.siteLocks.admeen),
      ...
      (Branding.isKongregate = function () {
        ...
        return (
          !(
            !Branding.siteLocks ||
            !Branding.siteLocks.hasOwnProperty("kongregate")
          ) &&
          ((kongregate = Branding.siteLocks.kongregate),
      ...
      (Branding.isNewgrounds = function () {
        ...
        return (
          !(
            !Branding.siteLocks ||
            !Branding.siteLocks.hasOwnProperty("newgrounds")
          ) &&
          ((newgrounds = Branding.siteLocks.newgrounds),
      ...
      (Branding.outGoingLinksAllowed = function () {
        return (
          !(
            Hosts.isAirfi() ||
            Branding.isSpecial() ||
            Branding.isContracted()
          ) &&
          (!BuildSettings.hasLinksSettingsForCustomBuild() ||
            BuildSettings.getLinkSettingsForCustomBuild())
        );
      }),
  ...
  var Utils = (function () {
    ...
    return (
        ...
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                return (
                  _a.trys.push([1, 3, , 4]), [4, window.gdsdk.getSession()]
                );
              case 2:
                return (
                  (result = _a.sent()),
      ...
      (Utils.getSourceSite = function (forceLocal) {
        ...
        if (
          (-1 !==
            (host = (forceLocal = void 0 === forceLocal ? !1 : forceLocal)
              ? window.location.host
              : host).indexOf("embed.gamedistribution.com") &&
      ...
      (Utils.getReferrer = function (host) {
        return -1 !== host.indexOf("?ref=")
          ? host.substr(host.indexOf("?ref=") + 5)
          : host;
      }),
      ...
      (Utils.getUrlParameter = function (name) {
        ...
        var name = new RegExp("[\\?&]" + name + "=([^&#]*)").exec(
          location.search
        );
        return null === name
          ? ""
          : decodeURIComponent(name[1].replace(/\+/g, " "));
      }),
      ...
      })(
        {
              ...
              !function () {
                ...
                var Tweenable = (function () {
                  ...
                  function tweenProps(
                    ...
                    for (prop in currentState)
                      currentState.hasOwnProperty(prop) &&
                        ((easingObjectProp =
                          "function" == typeof (easingObjectProp = easing[prop])
                            ? easingObjectProp
                  ...
                  function applyFilter(tweenable, filterName) {
                    ...
                    each(filters, function (name) {
                      void 0 !== filters[name][filterName] &&
                  ...
                  return (
                    ...
                    (Tweenable.prototype.tween = function (opt_config) {
                      return this._isTweening
                        ? this
                        : ((void 0 === opt_config && this._configured) ||
                ...
                Tweenable.shallowCopy(Tweenable.prototype.formula, {
                  ...
                  easeInOutBack: function (pos) {
                    var s = 1.70158;
                    return (pos /= 0.5) < 1
                      ? pos * pos * ((1 + (s *= 1.525)) * pos - s) * 0.5
                      : 0.5 *
                          ((pos -= 2) * pos * ((1 + (s *= 1.525)) * pos + s) +
                            2);
                  },
                  ...
                  (Tweenable.setBezierFunction = function (
                    ...
                    return (
                      ...
                      (Tweenable.prototype.formula[name] =
                  ...
                  (Tweenable.interpolate = function (
                    ...
                    var easing = Tweenable.composeEasingObject(
                      from,
                      easing || "linear"
                    );
                    mockTweenable.set({});
                    ...
                    var filterArgs = getInterpolatedValues(
                      from,
                      current,
                      targetState,
                      position,
                  ...
                  (function (Tweenable) {
                    ...
                    function getFormatManifests(stateObject) {
                      ...
                      return (
                        Tweenable.each(stateObject, function (prop) {
                          ...
                          var rawValues;
                          "string" == typeof currentProp &&
                            ((rawValues = getValuesFrom(currentProp)),
                    ...
                    function extractPropertyChunks(stateObject, chunkNames) {
                      ...
                      for (var i = 0; i < chunkNamesLength; i++)
                        (extractedValues[(currentChunkName = chunkNames[i])] =
                    ...
                    function expandEasingObject(easingObject, tokenData) {
                      Tweenable.each(tokenData, function (prop) {
                        ...
                        if ("string" == typeof easing) {
                          ...
                          var lastEasingChunk =
                            easingChunks[easingChunks.length - 1];
          ...
          2: [
            function (require, module, exports) {
              ...
              (((require.prototype = new Shape()).constructor =
          ...
          3: [
            function (require, module, exports) {
              ...
              (((require.prototype = new Shape()).constructor =
                require).prototype._initializeSvg = function _initializeSvg(
                svg,
                opts
              ) {
            ...
            function (require, module, exports) {
              ...
              (require.prototype.value = function value() {
                ...
                (require.prototype.set = function set(progress) {
                  ...
                  utils.isFunction(step) &&
                    ((easing = this._easing(this._opts.easing)),
                    step(
                      this._calculateTo(progress, easing),
                ...
                (require.prototype.animate = function animate(
                  progress,
                  opts,
                  cb
                ) {
                  (opts = opts || {}),
                    utils.isFunction(opts) && ((cb = opts), (opts = {}));
                  var passedOpts = utils.extend({}, opts);
                  var defaultOpts = utils.extend({}, this._opts);
                  opts = utils.extend(defaultOpts, opts);
                  var defaultOpts = this._easing(opts.easing);
                  var passedOpts = this._resolveFromAndTo(
                    progress,
                    defaultOpts,
                    passedOpts
                  );
                ...
                (require.prototype._getComputedDashOffset =
                ...
                (require.prototype._progressToOffset =
                  function _progressToOffset(progress) {
                    var length = this.path.getTotalLength();
                    return length - progress * length;
                  }),
                (require.prototype._resolveFromAndTo =
                ...
                (require.prototype._calculateFrom = function _calculateFrom(
                  easing
                ) {
                ...
                (require.prototype._calculateTo = function _calculateTo(
                  progress,
                  easing
                ) {
                  return Tweenable.interpolate(
                ...
                (require.prototype._easing = function _easing(easing) {
                  return EASING_ALIASES.hasOwnProperty(easing)
                    ? EASING_ALIASES[easing]
                    : easing;
                }),
                (module.exports = require);
            },
          ...
          6: [
            function (require, module, exports) {
              ...
              (((require.prototype = new Shape()).constructor =
                ...
                (require.prototype._initializeTextContainer =
                ...
                (require.prototype._trailString =
              ...
              var require = function Shape(container, opts) {
                ...
                if (0 !== arguments.length) {
                  ...
                  (this._container = element),
                    ...
                    this._opts.svgStyle &&
                      utils.setStyles(opts.svg, this._opts.svgStyle),
                    (this.svg = opts.svg),
                    (this.path = opts.path),
              ...
              (require.prototype.animate = function animate(
                ...
                (require.prototype.setText = function setText(newText) {
                  ...
                  null === this.text &&
                    ...
                    utils.isObject(newText)
                      ? (utils.removeChildren(this.text),
                        this.text.appendChild(newText))
                      : (this.text.innerHTML = newText);
                }),
                (require.prototype._createSvgView = function _createSvgView(
                  opts
                ) {
                  ...
                  var trailPath = null;
                  (opts.trailColor || opts.trailWidth) &&
                    ((trailPath = this._createTrail(opts)),
                    svg.appendChild(trailPath));
                  var opts = this._createPath(opts);
                  return (
                    svg.appendChild(opts),
                    {
                      svg: svg,
                      path: opts,
                      trail: trailPath,
                ...
                (require.prototype._createTrail = function _createTrail(opts) {
                  ...
                  return (
                    opts.trailColor || (opts.trailColor = "#eee"),
                    opts.trailWidth || (opts.trailWidth = opts.strokeWidth),
                ...
                (require.prototype._createPathElement =
                ...
                (require.prototype._createTextContainer =
                ...
                (require.prototype._initializeTextContainer = function (
                  opts,
                  container,
                  element
                ) {}),
                ...
                (require.prototype._warnContainerAspectRatio =
            ...
            function (require, module, exports) {
              ...
              function extend(destination, source, recursive) {
                ...
                (source = source || {}))) {
                  ...
                  source.hasOwnProperty(attrName) &&
                    ((destVal = destination[attrName]),
                    (sourceVal = source[attrName]),
                    recursive && isObject(destVal) && isObject(sourceVal)
              ...
              function setStyles(element, styles) {
                forEachObject(styles, function (styleValue, styleName) {
                  null != styleValue &&
                    (isObject(styleValue) && !0 === styleValue.prefix
  ...
  var BrandingDomain = (function () {
    ...
    return (
            ...
            switch (_a.label) {
              case 0:
                return (
                  ...
                  (this.circleLoader = new progressbar.Circle(
                    "#h5branding-bar",
                    {
                      strokeWidth: 3,
                  ...
                  (style = document.getElementById("h5branding-version")) &&
                    (style.innerHTML = this.options.version),
                  [4, this.loadLibs()]
                );
              case 1:
                ...
                return (
                  ...
                  (background = document.getElementById(
                    ...
                    (background.style.backgroundColor =
                      Branding.brandingBackgroundColor),
                  (background = document.getElementById("h5branding-logo")) &&
                    Utils.getBrandingDomain() !==
                      exports.BrandingDomain.Neutral &&
                    (((logo = document.createElement("img")).src =
                      Branding.brandingLogoUrl.replace("_small", "")),
      ...
      (SplashLoader.prototype.setScriptloadProgress = function (
        ...
        var progress;
        this.circleLoader.animate(
          (0.3 * increment) / maxScripts,
          null,
          function () {}
        );
      }),
      (SplashLoader.prototype.setLoadProgress = function (progress) {
        ...
        var button_1;
        this.loaded &&
          (100 === (this.progress = progress = 30 + 0.7 * progress)
            ? ((button_1 = document.querySelector("#h5branding-button")),
              this.circleLoader.animate(1, null, function () {
                h5branding.SplashLoader.getInstance().onPlayButtonClick();
                !Utils.inGDGameZone() && button_1 && !0 === _this.showPlayButton
                  ? (button_1.style.display = "block")
                  : (!Utils.inGDGameZone() && !1 !== _this.showPlayButton) ||
    ...
    var __webpack_modules__ = {
      ...
      729: (module, exports, __webpack_require__) => {
        ...
        (__webpack_require__ = [
          ...
          void 0 !==
            (exports = function (require, exports, AdWrapper_1, types_1) {
              "use strict";
              Object.defineProperty(exports, "__esModule", {
                value: !0,
              }),
                (exports.AdType =
                  ...
                  exports.GameDistributionAlignment =
                  exports.AdWrapper =
                    void 0),
            ...
            }.apply(exports, __webpack_require__)) &&
      ...
      470: (module, exports, __webpack_require__) => {
        ...
        (__webpack_require__ = [
          ...
          void 0 !==
            (exports = function (require, exports, shared_1) {
              "use strict";
              Object.defineProperty(exports, "__esModule", {
                value: !0,
              }),
              ...
              var JioAdProvider = (function () {
                ...
                return (
                  ...
                  (JioAdProvider.prototype.showAd = function (
                    adType,
                    adSpotKey
                  ) {
                    var _this = this;
                    if (
                      ...
                      if (
                        (window.hasOwnProperty("onAdView") &&
                          (window.onAdView, 1) &&
                          (window.onAdView = function (cbAdSpot) {
                            setTimeout(function () {
                              console.log("JioGames ads: onAdView " + cbAdSpot),
                                _this.resumeGameplay();
                            }, 2e3);
                          }),
                        window.hasOwnProperty("onAdClosed") &&
                          (window.onAdClosed, 1) &&
                          (window.onAdClosed = function (
                            ...
                            null != localData &&
                              1 < localData.length &&
                              ((data = localData[0].trim()),
                              (pIsVideoCompleted = Boolean(
                                localData[1].trim()
                              )),
                              (pIsEligibleForReward = Boolean(
                                localData[2].trim()
                              ))),
                              data === window.adSpotInterstitial &&
                                (window.isAdReady = !1),
                              data === window.adSpotRewardedVideo &&
                                ((window.isRVReady = !1),
                                pIsEligibleForReward) &&
                                pIsVideoCompleted &&
                                _this.adManager.emit(
                                  shared_1.AdEvents.AD_REWARDED
                                ),
                              setTimeout(function () {
                      ...
                      if (
                        adType === shared_1.AdType.rewarded &&
                        window.hasOwnProperty("showAdRewardedVideo") &&
                        (window.showAdRewardedVideo, 1)
                      )
                        try {
                          (window.adSpotRewardedVideo = adSpotKey),
                            window.showAdRewardedVideo(
                              adSpotKey,
                              window.gamePackage
                            );
                        } catch (e) {
                      ...
                      console.log(
                        "Cannot show Jio ads; Ads were not preloaded or failed to load. Resuming game"
                      ),
                        this.resumeGameplay();
                  }),
                  ...
                  (JioAdProvider.prototype.preloadAd = function (
                    adType,
                    adSpotKey
                  ) {
                    if (
                      ...
                      adType === shared_1.AdType.interstitial &&
                        window.hasOwnProperty("cacheAdMidRoll") &&
                        (window.cacheAdMidRoll, 1))
                    )
                      try {
                        (window.adSpotInterstitial = adSpotKey),
                    ...
                    if (
                      adType === shared_1.AdType.rewarded &&
                      window.hasOwnProperty("cacheAdRewardedVideo") &&
                      (window.cacheAdRewardedVideo, 1)
                    )
                      try {
                        (window.adSpotRewardedVideo = adSpotKey),
                          window.cacheAdRewardedVideo(
                            adSpotKey,
                            window.gamePackage
                          );
                      } catch (e) {
                        console.log(
                          "Error cacheAdRewardedVideo of Jio rewarded ads"
                        );
                      }
                    window.hasOwnProperty("onAdPrepared") &&
                      (window.onAdPrepared, 1) &&
                      (window.onAdPrepared = function (preparedAdSpotKey) {
                        try {
                          preparedAdSpotKey === window.adSpotInterstitial &&
                            (window.isAdReady = !0),
                            preparedAdSpotKey === window.adSpotRewardedVideo &&
                              (window.isRVReady = !0);
                        } catch (e) {
                          console.log(
                            "Error onAdPrepared for Jio rewarded ads"
                          );
                        }
                      }),
                      window.hasOwnProperty("onAdFailedToLoad") &&
                        (window.onAdFailedToLoad, 1) &&
                        (window.onAdFailedToLoad = function (
                          data,
                          pDescription
                        ) {
                          var localData = data.split(",");
                          ...
                          null != localData &&
                            1 < localData.length &&
                            ((failedAdSpotKey = localData[0].trim()),
                            (pDescription = localData[1].trim()));
                          try {
                            failedAdSpotKey === window.adSpotInterstitial &&
                              (window.isAdReady = !1),
                              failedAdSpotKey === window.adSpotRewardedVideo &&
                                (window.isRVReady = !1),
                              console.log(
      ...
      766: (module, exports, __webpack_require__) => {
        ...
        (__webpack_require__ = [
          ...
          void 0 !==
            (exports = function (require, exports, JioAdProvider_1) {
              "use strict";
              Object.defineProperty(exports, "__esModule", {
                value: !0,
              }),
          ...
          void 0 !==
            (exports = function (require, exports, shared_1) {
              ...
              var AdFreeUntrackedProvider = (function () {
                ...
                return (
                  (AdFreeUntrackedProvider.prototype.setManager = function (
                    manager
                  ) {
                    this.adManager = manager;
                  }),
                  (AdFreeUntrackedProvider.prototype.showAd = function (
                    adType
                  ) {
                    void 0 === adType &&
                      (adType = shared_1.AdType.interstitial),
                  ...
                  (AdFreeUntrackedProvider.prototype.resumeGameplay =
                    function () {
                      this.adManager.emit(shared_1.AdEvents.CONTENT_RESUMED);
                    }),
                  (AdFreeUntrackedProvider.prototype.preloadAd = function (
                    adType
                  ) {
                    void 0 === adType &&
                      (adType = shared_1.AdType.interstitial);
                  }),
                  (AdFreeUntrackedProvider.prototype.destroyAd =
                    function () {}),
                  (AdFreeUntrackedProvider.prototype.hideAd = function () {}),
                  (AdFreeUntrackedProvider.prototype.adAvailable = function (
                    adType
                  ) {
                    return !0;
                  }),
          ...
          void 0 !==
            (exports = function (require, exports, shared_1) {
              ...
              Object.defineProperty(exports, "__esModule", {
                ...
                (exports.GameDistribution = exports.GameDistributionAdType =
                  void 0),
                (function (GameDistributionAdType) {
                  ...
                  (GameDistributionAdType =
                    exports.GameDistributionAdType ||
                    (exports.GameDistributionAdType = {}))
                );
                  ...
                  (window.GD_OPTIONS = {
                    ...
                    onEvent: function (event) {
                      switch (event.name) {
                        case "SDK_GAME_PAUSE":
                          _this.adManager.emit(
                            shared_1.AdEvents.CONTENT_PAUSED
                          );
                          break;
                        case "SDK_ERROR":
                          _this.adManager.emit(
                            shared_1.AdEvents.CONTENT_RESUMED
                          );
                          break;
                        case "SDK_READY":
                          _this.sdkLoaded();
                    ...
                    gameId.getElementById(id) ||
                      (((gameId = gameId.createElement(s)).id = id),
                      (gameId.src =
                        "patch/js/gd-sdk.js?html5.api.gamedistribution.com/main.min.js"),
                      fjs.parentNode &&
                        fjs.parentNode.insertBefore(gameId, fjs));
                }
                return (
                  ...
                  (GameDistribution.prototype.preloadAd = function (adType) {
                    ...
                    !this.hasRewarded &&
                      ...
                      window.gdsdk
                        .preloadAd(GameDistributionAdType.rewarded)
                        .then(function () {
                          (_this.hasRewarded = !0),
                            _this.adManager.emit(
                              shared_1.AdEvents.AD_LOADED,
                              adType
                            );
                        }));
                  }),
                  (GameDistribution.prototype.adAvailable = function (adType) {
                    return (
                      adType !== shared_1.AdType.rewarded || this.hasRewarded
                    );
                  }),
                ...
                return (
                  (GameDistributionBanner.prototype.loadBanner = function () {
                    return void 0 === window.gdsdk
                      ...
                      : window.gdsdk.showAd(
                          GameDistribution_1.GameDistributionAdType.display,
                          {
                  ...
                  (GameDistributionBanner.prototype.alignIn = function (
                    element,
                    position
                  ) {
                    var _this = this;
                  ...
                  (GameDistributionBanner.prototype.setOffset = function (
                    x,
                    y
                  ) {
                    void 0 === y && (y = 0),
                  ...
                  (GameDistributionBanner.prototype.resize = function () {
                    if (this.parent) {
                      ...
                      switch (this.alignment) {
                        case gamedistribution_1.GameDistributionAlignment
                          .TopLeft:
                          this.position(
                  ...
                  (GameDistributionBanner.prototype.setSize = function (size) {
                    ...
                    switch (size) {
                      default:
                      case gamedistribution_1.GameDistributionBannerSize
                        .LargeRectangle:
                  ...
                  (GameDistributionBanner.prototype.scale = function (factor) {
                    (this.element.style.transformOrigin = "left top"),
                      ...
                      (this.element.style.transform = "scale(".concat(
                        factor,
                        ")"
                      ));
                  }),
              ...
              var YandexAdProvider = (function () {
                function YandexAdProvider(partnerID) {
                  ...
                  (this.adsEnabled = !1),
                    ...
                    d.getElementById(id) ||
                      ((d = d.createElement(s)).addEventListener(
                        "load",
                        function () {
                          _this.initialize();
                        }
        ...
        (__webpack_require__ = [
          ...
          void 0 !==
            (exports = function (
              require,
              exports,
              AdFreeUntrackedProvider_1,
              DummyProvider_1,
              GameDistribution_1,
              GameDistributionBanner_1,
              YandexAdProvider_1
            ) {
              "use strict";
              Object.defineProperty(exports, "__esModule", {
                ...
                (exports.YandexAdProvider =
                  exports.GameDistributionBanner =
                  exports.GameDistribution =
                  exports.DummyProvider =
                  exports.AdFreeUntrackedProvider =
                    void 0),
      ...
      869: (module, exports, __webpack_require__) => {
        ...
        void 0 !==
          (__webpack_require__ = function (require, exports) {
            "use strict";
            ...
            Object.defineProperty(exports, "__esModule", {
              ...
              (function (GameDistributionBannerSize) {
                (GameDistributionBannerSize[
                  (GameDistributionBannerSize.LargeRectangle = 0)
                ] = "LargeRectangle"),
                  (GameDistributionBannerSize[
                    (GameDistributionBannerSize.MediumRectangle = 1)
                  ] = "MediumRectangle"),
                  (GameDistributionBannerSize[
                    (GameDistributionBannerSize.Billboard = 2)
                  ] = "Billboard"),
                  (GameDistributionBannerSize[
                    (GameDistributionBannerSize.Leaderboard = 3)
                  ] = "Leaderboard"),
                  (GameDistributionBannerSize[
                    (GameDistributionBannerSize.Skyscraper = 4)
                  ] = "Skyscraper"),
                  (GameDistributionBannerSize[
                    (GameDistributionBannerSize.WideSkyscraper = 5)
                  ] = "WideSkyscraper");
              })(
                (GameDistributionBannerSize =
                  exports.GameDistributionBannerSize ||
              ...
              (function (GameDistributionAlignment) {
                (GameDistributionAlignment[
                  (GameDistributionAlignment.TopLeft = 0)
                ] = "TopLeft"),
                  (GameDistributionAlignment[
                    (GameDistributionAlignment.TopCenter = 1)
                  ] = "TopCenter"),
                  (GameDistributionAlignment[
                    (GameDistributionAlignment.TopRight = 2)
                  ] = "TopRight"),
                  (GameDistributionAlignment[
                    (GameDistributionAlignment.CenterLeft = 3)
                  ] = "CenterLeft"),
                  (GameDistributionAlignment[
                    (GameDistributionAlignment.Center = 4)
                  ] = "Center"),
                  (GameDistributionAlignment[
                    (GameDistributionAlignment.CenterRight = 5)
                  ] = "CenterRight"),
                  (GameDistributionAlignment[
                    (GameDistributionAlignment.BottomLeft = 6)
                  ] = "BottomLeft"),
                  (GameDistributionAlignment[
                    (GameDistributionAlignment.BottomCenter = 7)
                  ] = "BottomCenter"),
                  (GameDistributionAlignment[
                    (GameDistributionAlignment.BottomRight = 8)
                  ] = "BottomRight");
              })(
                (GameDistributionAlignment =
                  exports.GameDistributionAlignment ||
          ...
          (__webpack_require__ = function (require, exports) {
            ...
            Object.defineProperty(exports, "__esModule", {
              ...
              (function (ProviderTypes) {
                ...
                (ProviderTypes =
                  exports.ProviderTypes || (exports.ProviderTypes = {}))
              );
          }.apply(
            exports,
            (__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports])
            ...
            (exports = function (
              ...
              var eventemitter3_1 = (function (_super) {
                function AdWrapper(type, id, jioConfig) {
                  ...
                  switch (
                    ((_this.bannerActive = !1), (_this.provider = null), type)
                  ) {
                ...
                return (
                  ...
                  (AdWrapper.prototype.loadBanner = function () {
                    ...
                    for (var _i = 0; _i < arguments.length; _i++)
                      args[_i] = arguments[_i];
                    return "function" == typeof this.provider.loadBanner
                      ? this.provider.loadBanner.apply(this.provider, args)
                      : null;
                  }),
