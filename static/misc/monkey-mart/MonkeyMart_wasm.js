...
var wasmImports = {
  Di: _PokiSdkJs_AddParameterForURL,
  Ci: _PokiSdkJs_CaptureError,
  Bi: _PokiSdkJs_CommercialBreak,
  Ai: _PokiSdkJs_GameplayStart,
  zi: _PokiSdkJs_GameplayStop,
  yi: _PokiSdkJs_GetURLParam,
  xi: _PokiSdkJs_InternalCaptureError,
  wi: _PokiSdkJs_IsAdBlocked,
  vi: _PokiSdkJs_RewardedBreak,
  ui: _PokiSdkJs_SetDebug,
  ti: _PokiSdkJs_ShareableURL,
  b: ___assert_fail,
  si: ___syscall__newselect,
  ri: ___syscall_accept4,
  qi: ___syscall_bind,
  pi: ___syscall_connect,
  oi: ___syscall_dup3,
  g: ___syscall_fcntl64,
  ni: ___syscall_getpeername,
  mi: ___syscall_getsockname,
  ba: ___syscall_getsockopt,
  li: ___syscall_ioctl,
  ki: ___syscall_listen,
  ji: ___syscall_mkdirat,
  aa: ___syscall_openat,
  ii: ___syscall_poll,
  hi: ___syscall_readlinkat,
  gi: ___syscall_recvfrom,
  fi: ___syscall_renameat,
  ei: ___syscall_rmdir,
  di: ___syscall_sendto,
  Aa: ___syscall_socket,
  ci: ___syscall_stat64,
  $: ___syscall_unlinkat,
  $h: __emscripten_get_now_is_monotonic,
  _h: __emscripten_lookup_name,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Ei"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Fi"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Gi"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["Hi"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["Ii"])(a0);
};
var _js_remote_configs_callback = Module["_js_remote_configs_callback"] = function () {
  return (_js_remote_configs_callback = Module["_js_remote_configs_callback"] = wasmExports["Ki"])();
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["Li"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["Mi"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["Ni"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["Oi"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["Pi"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["Qi"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["Ri"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["Si"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["Ti"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["Ui"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["Vi"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["Wi"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["Xi"])(a0, a1);
};
