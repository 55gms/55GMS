...
var wasmImports = {
  Yh: _JsToDef_RegisterCallbacks,
  Xh: _JsToDef_RemoveCallbacks,
  Wh: _PokiSdkJs_AddParameterForURL,
  Vh: _PokiSdkJs_CaptureError,
  Uh: _PokiSdkJs_CommercialBreak,
  Th: _PokiSdkJs_GameplayStart,
  Sh: _PokiSdkJs_GameplayStop,
  Rh: _PokiSdkJs_GetURLParam,
  Qh: _PokiSdkJs_InternalCaptureError,
  Ph: _PokiSdkJs_IsAdBlocked,
  Oh: _PokiSdkJs_RewardedBreak,
  Nh: _PokiSdkJs_SetDebug,
  Mh: _PokiSdkJs_ShareableURL,
  b: ___assert_fail,
